...
import { displaNotificationDrawer, hideNotificationDrawer, loginRequest, logout } from '../actions/uiActionCreators';
...
export class App extends Component {
  ...
  render() {
    const { isLoggedIn, displayDrawer, displaNotificationDrawer, hideNotificationDrawer, login, logout } = this.props;
